...
class Pet:
    ...
    die()
    """
    def __init__(self, name, type='snake', age=0, hunger=0, poop=0, sadness=0, dead=False):
        """Initializes the Pet"""
        self.type = type
        self.name = name
        self.age = age
    ...
    def evaluate_lod(self):
        ...
        if (self.hunger == 5 and self.poop == 5) or (self.poop == 5 and 
            self.sadness == 5) or (self.hunger == 5 and self.sadness == 5):
            self.dead = True
            return self.dead
